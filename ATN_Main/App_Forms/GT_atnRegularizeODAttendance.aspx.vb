Partial Class GT_atnRegularizeODAttendance
  ...
  End Sub
	Private Function LoadIncompleteAttendance(ByVal CardNo As String) As String
		...
		Dim oInAtns As List(Of SIS.ATN.atnProcessedPunch) = SIS.ATN.atnProcessedPunch.NewODGetAllIncompleteAttendance(CardNo)
				...
				If oLT.Applyiable Then
					If oLT.MainType Then
						...
						If oLT.LeaveTypeID = "OD" Then
							...
							Pnl.BorderStyle = BorderStyle.Solid
              Pnl.BorderWidth = 1
              Pnl.BackColor = Drawing.Color.AntiqueWhite
							Pnl.Height = 100
