<%@ Page Title="ISGEC:Mannual OD Regularization" Language="VB"  MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnMannualODRegularization.aspx.vb" Inherits="GT_MannualODRegularization" %>
...
<div id="div1" class="page">
    <div id="div2" class="caption">
					<asp:Label ID="LabelatnAppliedApplications" runat="server" Font-Bold="true" Font-Size="14px" Text="Mannual OD Regularization by HR"></asp:Label>
    </div>
