Partial Class GF_atnApproverChangeRequest
  ...
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnApproverChangeRequest.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnApproverChangeRequest.aspx"
