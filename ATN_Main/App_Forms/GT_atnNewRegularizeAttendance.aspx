<%@ Page Title="ISGEC:Regularize Attendance" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnNewRegularizeAttendance.aspx.vb" Inherits="GT_atnNewRegularizeAttendance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    ...
    <div id="div2" class="caption">
			<asp:Label ID="LabelatnAppliedApplications" runat="server"  Text="List Incomplete Attendance [NEW]"></asp:Label>
    </div>
