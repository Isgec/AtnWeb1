Partial Class GT_atnNewRegularizeAttendance
  ...
  End Sub
	Private Function LoadIncompleteAttendance(ByVal CardNo As String) As String
		...
		Dim oInAtns As List(Of SIS.ATN.atnProcessedPunch) = SIS.ATN.atnProcessedPunch.NewGetAllIncompleteAttendance(CardNo)
