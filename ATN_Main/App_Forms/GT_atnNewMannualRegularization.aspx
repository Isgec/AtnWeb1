<%@ Page Title="ISGEC:Mannual Regularization" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnNewMannualRegularization.aspx.vb" Inherits="GT_NewMannualRegularization" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div1" class="page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelatnAppliedApplications" runat="server" Font-Bold="true" Font-Size="14px" Text="NEW Mannual Regularization by HR"></asp:Label>
    </div>
