<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GD_atnApproveApplication.aspx.vb" Inherits="GD_atnApproveApplication" title="Display List: Approve Application" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    ...
    <div id="div3" class="caption">
			<asp:Label ID="LabelatnAppliedApplications" runat="server"  Text="&nbsp;List Approve Applications"></asp:Label>
    </div>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      ToolType = "lgNDGrid"
      EnableAdd = "False"
      ValidationGroup = "atnApproveApplication"
      SearchContext = "atnApproveApplication"
      runat = "server" />
    ...
    <asp:GridView runat="server"  SkinId="gv_silver" ID="GridView1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="LeaveApplID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Verified By" SortExpression="HRM_Employees2_EmployeeName">
          <ItemTemplate>
             <asp:Label ID="LabelVerifiedBy" runat="server" Text='<%# Eval("VerifiedByHRM_Employees.EmployeeName") %>'></asp:Label>
          </ItemTemplate>
          <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Comments">
          <ItemTemplate>
						<asp:TextBox ID="F_Remarks" runat="server" CssClass="mytxt" Width="150px" MaxLength="100" ToolTip="Enter Comments" BehaviorID='<%# Eval("LeaveApplID") %>' Text='<%# Bind("ApprovalRemark") %>'></asp:TextBox>
          </ItemTemplate>
        <HeaderStyle Width="150px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Approved">
          <ItemTemplate>
						<asp:ImageButton ID="Approved" runat="server" ToolTip="Click to Approve" ImageUrl="~/App_Themes/Default/Images/docok.png" BehaviorID='<%# Eval("LeaveApplID") %>' CommandName="Approved" CommandArgument='<%# Eval("LeaveApplID") %>'  />
          </ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      runat = "server"
      DataObjectTypeName = "SIS.ATN.atnApproveApplication"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "SelectList"
      TypeName = "SIS.ATN.atnApproveApplication"
