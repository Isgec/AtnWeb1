...
Namespace SIS.ATN
	<DataObject()> _
	Partial Public Class atnAttendanceUnderApproval
		...
		Private _ApplHeader4_ApprovedBy As String
		...
		Public Property LeaveTypes3_Description() As String
			...
			End Set
		End Property
		Public Property ApplHeader4_ApprovedBy() As String
			Get
				Return _ApplHeader4_ApprovedBy
			End Get
			Set(ByVal value As String)
				If Convert.IsDBNull(value) Then
					_ApplHeader4_ApprovedBy = ""
				Else
					_ApplHeader4_ApprovedBy = value
				End If
			End Set
		End Property
		Public Property Employees5_EmployeeName() As String
			...
			End Set
		End Property
		Public Shared Function GetAttendanceUnderApproval(ByVal ApprovedBy As String) As List(Of SIS.ATN.atnAttendanceUnderApproval)
			Dim Results As List(Of SIS.ATN.atnAttendanceUnderApproval) = Nothing
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spatn_LG_AttendanceUnderApproval"
					SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@ApprovedBy", SqlDbType.NVarChar, 50, ApprovedBy)
					...
					_RecordCount = -1
					Results = New List(Of SIS.ATN.atnAttendanceUnderApproval)()
					Con.Open()
					Dim Reader As SqlDataReader = Cmd.ExecuteReader()
					While (Reader.Read())
						Results.Add(New SIS.ATN.atnAttendanceUnderApproval(Reader))
					End While
					Reader.Close()
			...
			Return Results
		End Function
		Public Shared Function GetHTMLAttendanceUnderApproval(ByVal ApprovedBy As String) As String
			Dim mRet As String = ""
			Dim oDays As List(Of SIS.ATN.atnAttendanceUnderApproval) = SIS.ATN.atnAttendanceUnderApproval.GetAttendanceUnderApproval(ApprovedBy)
			...
			For Each oDy As SIS.ATN.atnAttendanceUnderApproval In oDays
